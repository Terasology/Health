...
import org.terasology.module.health.systems.BlockDamageRenderer;
...
class BlockDamageRendererTest {
    ...
    class DamageEffectsNumber {
        @ParameterizedTest
        @MethodSource("org.terasology.module.health.systems.BlockDamageRendererTest#validHealthComponents")
        ...
        @ParameterizedTest
        @MethodSource("org.terasology.module.health.systems.BlockDamageRendererTest#invalidHealthComponents")
